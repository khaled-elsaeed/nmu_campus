...
@section('title', __('Create Reservation'))

@section('page-content')
<div class="container-xxl flex-grow-1 container-p-y">
    <x-ui.page-header 
        :title="__('Create Reservation')"
        :description="__('Add a new reservation to the system')"
        icon="bx bx-calendar"
    >
    ...
    <div class="row justify-content-center">
        ...
        <div class="card mb-4 shadow-sm border-0">
            <div class="card-header bg-white border-bottom-0 pb-0">
                <h5 class="mb-0"><i class="bx bx-id-card me-2"></i>{{ __('Enter National ID') }}</h5>
            </div>
            <div class="card-body pt-3">
                <div class="row g-3 align-items-end">
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="search_national_id" placeholder="{{ __('Enter National ID Number') }}">
                    </div>
                    <div class="col-md-4">
        ...
        <form id="addReservationForm" method="POST" action="{{ route('reservations.store') }}" class="d-none">
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pb-0">
                    <h5 class="mb-0"><i class="bx bx-home me-2"></i>{{ __('Accommodation Details') }}</h5>
                </div>
                <div class="card-body pt-3">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label for="add_accommodation_type" class="form-label">{{ __('Accommodation Type') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <label for="add_building_id" class="form-label">{{ __('Building') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4" id="apartment-select-group" style="display:none;">
                            <label for="add_apartment_id" class="form-label">{{ __('Apartment') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="row g-3 mt-2">
                        <!-- Period Selector -->
                        <div class="col-md-4">
                            <label for="add_period" class="form-label">{{ __('Period') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4" id="academic-term-group" style="display:none;">
                            <label for="add_academic_term_id" class="form-label">{{ __('Academic Term') }}</label>
                        ...
                        <div class="col-md-8" id="checkinout-group" style="display:none;">
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <label for="add_check_in_date" class="form-label">{{ __('Check-in Date') }}</label>
                                    <input type="date" class="form-control" id="add_check_in_date" name="check_in_date">
                                </div>
                                <div class="col-md-6">
                                    <label for="add_check_out_date" class="form-label">{{ __('Check-out Date') }}</label>
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pb-0">
                    <h5 class="mb-0"><i class="bx bx-cube me-2"></i>{{ __('Equipment') }}</h5>
                </div>
                <div class="card-body pt-3">
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pb-0">
                    <h5 class="mb-0"><i class="bx bx-info-circle me-2"></i>{{ __('Additional Information') }}</h5>
                </div>
                <div class="card-body pt-3">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="add_notes" class="form-label">{{ __('Notes') }}</label>
                            <textarea class="form-control" id="add_notes" name="notes" rows="3" placeholder="{{ __('Enter any additional notes here...') }}"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit" class="btn btn-lg btn-primary px-4 shadow">
                    <i class="bx bx-save"></i> {{ __('Save Reservation') }}
                </button>
            </div>
        </form>
    </div>
