...
<div class="row d-none" id="stay-preference-div">
    ...
    <div class="col-md-6 mb-3 d-none" id="sibling-details-div">
    ...
    <div class="col-md-6 mb-3 d-none" id="room-type-div">
...
<div class="row d-none" id="double-room-options-div">
    <div class="col-md-6 mb-3">
        ...
        <select class="form-select" id="double-room-preference" name="double_room_preference">
            ...
            <option value="single_bed">{{ __('Single Bed') }}</option>
            <option value="double_bed">{{ __('Double Bed') }}</option>
        </select>
