...
class AcademicTermService
{
    ...
    public function getDatatable(): JsonResponse
    {
        ...
        return DataTables::of($terms)
            ->addIndexColumn()
            ->editColumn('season', fn($term) => __($term->season))
            ->editColumn('year', fn($term) => $term->year)
            ->editColumn('code', fn($term) => $term->code)
            ->editColumn('start_date', fn($term) => formatDate($term->start_date))
            ->editColumn('end_date', fn($term) => formatDate($term->end_date) ?: __('Not Set'))
            ->editColumn('reservations', fn($term) => formatNumber($term->reservations_count))
